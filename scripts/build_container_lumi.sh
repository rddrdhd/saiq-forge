...
# singularity exec --bind $PWD:/workspace --bind /scratch/project_XXXXXXXXX/pathfinder/data/:/data --pwd /workspace saiq-forge.sif python3 scripts/pcap_to_parquet.py
# singularity exec --bind $PWD:/workspace --bind /scratch/project_XXXXXXXXX/pathfinder/data/ --pwd /workspace saiq-forge.sif python3 scripts/pcap_to_parquet.py
